...
public interface TenantService {
    ...
    Tenant updateLicense(TenantLicenseUpdateRequest request);

    String buildLicenseWarning(Tenant tenant, boolean administrator);

    void validateLicense(Tenant tenant);
}
